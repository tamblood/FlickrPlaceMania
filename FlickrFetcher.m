...
+ (NSString *)getCountryNameFromFlickrPlaceName:(NSString *)flickrPlaceName
{
  NSString *countryName = nil;
  
  NSArray *wordsInName = [flickrPlaceName componentsSeparatedByString:@","];
  countryName = [wordsInName lastObject];
  
  return countryName;
}

+ (NSString *)getStateNameFromFlickrPlaceName:(NSString *)flickrPlaceName
{
  NSString *countryName = nil;
  
  NSArray *wordsInName = [flickrPlaceName componentsSeparatedByString:@","];
  countryName = wordsInName[1];
